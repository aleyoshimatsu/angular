...
export class HotObservablesIntroComponent implements OnInit {
  ...
  ngOnInit(): void {
    let myBtnClickObservable: Observable<number> = fromEvent(
    ...
    setTimeout(() => {
      producer.addListener( (n) => console.log('button clicked 1', n) );
      producer.addListener( (n) => console.log('button clicked 2', n) );
    }, 4000);
